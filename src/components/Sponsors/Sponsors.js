            ...
            <section id='titleSponsors'>
                ...
                <div className='container'>
                    ...
                    <div className='col s12 m6 l4 portfolio-item'>
                        <a class="portfolio-link" href="https://www.nivea.in/" target="_blank">
                ...
                <div className='container'>
                    ...
                    <div className='row'>
                        ...
                        <div className='col s12 m6 l6'>
                            ...
                            <img id='shuuutttt' class="img-fluid" src={photo3} alt="Nivea" />
                            
                            <div className='large-text'>helooojb</div>
